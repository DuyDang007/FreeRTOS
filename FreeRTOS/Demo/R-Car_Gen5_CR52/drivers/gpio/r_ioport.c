...
static fsp_err_t R_IOPORT_ISR_Handler (void * const p_context) {
    ioport_instance_ctrl_t * p_instance_ctrl = (ioport_instance_ctrl_t *) p_context;
    ...
    gpioClearInterruptHandler(group_pin);
}
/***********************************************************************************************************************
...
const ioport_api_t g_ioport_on_ioport =
{
    ...
    .pinInterruptInput    = R_IOPORT_PinInterruptInput,
    .callbackSet          = R_IOPORT_CallbackSet,
 ...
 *
 * @note This function is re-entrant for different pins.
 * This function will change the configuration of the pin with Input Interrupt Mode.
 **********************************************************************************************************************/

fsp_err_t R_IOPORT_PinInterruptInput (ioport_ctrl_t * const p_ctrl, bsp_io_port_pin_t pin, bsp_interrupt_input_t option)
{
#if (1 == IOPORT_CFG_PARAM_CHECKING_ENABLE)
    FSP_ASSERT(NULL != p_instance_ctrl);
    FSP_ERROR_RETURN(IOPORT_OPEN == p_instance_ctrl->open, FSP_ERR_NOT_OPEN);
	...
	(void) gpioSetPinInterruptInputMode(port_num, pin_num, option);
 ...
 * Implements ioport_api_t::callbackSet
 *
 * @retval  FSP_SUCCESS                  Callback updated successfully.
 * @retval  FSP_ERR_ASSERTION            A required pointer is NULL.
 * @retval  FSP_ERR_NOT_OPEN             The control block has not been opened.
 **********************************************************************************************************************/
fsp_err_t R_IOPORT_CallbackSet (ioport_ctrl_t * const p_ctrl,
                                ...
                                void * const p_context)
{
	...
	uint32_t port_num = (IOPORT_PRV_PORT_BITS & (ioport_size_t) port_pin) >> IOPORT_PRV_PORT_OFFSET;

	//printf("p_context=0x%x\n", p_context);
	//printf("p_instance_ctrl=0x%x\n", p_instance_ctrl);
	...
	(void) gpioSetupIRQ(port_num, (void *)R_IOPORT_ISR_Handler, p_context);
...
fsp_err_t R_IOPORT_PinRead (ioport_ctrl_t * const p_ctrl, bsp_io_port_pin_t pin, bsp_io_level_t * p_pin_value)
{
	...
	*p_pin_value = gpioReadPin(port, pin_num);
...
fsp_err_t R_IOPORT_PortRead (ioport_ctrl_t * const p_ctrl, bsp_io_port_t port, ioport_size_t * p_port_value)
{
	...
	*p_port_value = gpioReadPort(port_num);
...
fsp_err_t R_IOPORT_PortWrite (ioport_ctrl_t * const p_ctrl, bsp_io_port_t port, ioport_size_t value, ioport_size_t mask)
{
	...
	/* Get port number */
	uint32_t port_num = (IOPORT_PRV_PORT_BITS & (ioport_size_t) port) >> IOPORT_PRV_PORT_OFFSET;
	//printf("PortWrite: port_num=%d\n", port_num);
	gpioSetPortOutput(port_num, value, mask);
...
fsp_err_t R_IOPORT_PinWrite (ioport_ctrl_t * const p_ctrl, bsp_io_port_pin_t pin, bsp_io_level_t level)
{
	...
	(void) gpioSetPinOutput(port_num, pin_num, level);
//    /* Get the port register address */
//#if BSP_FEATURE_IOPORT_HAS_NONSAFETY_DEDICATED_PORT
//    if (port_num > BSP_FEATURE_IOPORT_SELECTABLE_PORT_MAX)
//    {
                                     ...
                                     ioport_size_t         mask)
{
	...
	/* Get port number */
	uint32_t port_num = (IOPORT_PRV_PORT_BITS & (ioport_size_t) port) >> IOPORT_PRV_PORT_OFFSET;
	//printf("DirectionSet: port_num=%d\n", port_num);

	(void) gpioSetPortGeneralMode(port_num, direction_values, mask);
...
fsp_err_t R_IOPORT_PinEventInputRead (ioport_ctrl_t * const p_ctrl, bsp_io_port_pin_t pin, bsp_io_level_t * p_pin_event)
{
	...
	//(void) gpioSetPinInterruptInputMode(port_num, pin_num, *(bsp_io_level_t*) p_pin_event);
...
static void r_ioport_pin_set (bsp_io_port_pin_t pin, ioport_cfg_data_t * p_cfg_data)
{
	...
	uint32_t port    = (IOPORT_PRV_PORT_BITS & (ioport_size_t) pin) >> IOPORT_PRV_PORT_OFFSET;
	uint32_t pin_num = (IOPORT_PRV_PIN_BITS & (ioport_size_t) pin);
	uint32_t cfg = *(uint32_t *)(p_cfg_data);

	if (cfg == BSP_IO_DIRECTION_OUTPUT || cfg == BSP_IO_DIRECTION_INPUT)
		(void) gpioSetPinGeneralMode(port, pin_num, cfg);
	else if (cfg == BSP_INTERRUPT_INPUT_RISING_EDGE ||
		 cfg == BSP_INTERRUPT_INPUT_FALLING_EDGE ||
		 cfg == BSP_INTERRUPT_INPUT_BOTH_EDGE)
		(void) gpioSetPinInterruptInputMode(port, pin_num, cfg);
