...
/**
 * Close the I2C channel and release associated resources.
 *
...
/**
 * Read data from the I2C bus into a destination buffer.
 *
...
/**
 * Write data to the I2C bus from a source buffer.
 *
 * @param[in]  p_ctrl  - Pointer to the I2C control structure.
...
/**
 * Abort the current I2C transaction and reset the I2C interface.
 *
 * @param[in]  p_ctrl - Pointer to the I2C control structure.
 *
 * @retval 0 if successful
...
/**
 * Set the I2C slave address to be used for communication.
 *
 * @param[in]  p_ctrl   - Pointer to the I2C control structure.
...
/**
 * Set the callback function to be called when an I2C interrupt occurs.
 *
 * @param[in]  p_ctrl            - Pointer to the I2C control structure.
...
/**
 * Get the current status of the I2C communication.
 *
 * @param[in]  p_ctrl   - Pointer to the I2C control structure.
